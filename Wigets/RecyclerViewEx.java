        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    ItemViewHolder viewHolder = (ItemViewHolder) getChildViewHolder(view);

                    mItemLayout = (LinearLayout) viewHolder.v;
                    mPosition = viewHolder.getAdapterPosition();

                   // mDelete = (ImageView) mItemLayout.findViewById(R.id.item_delete);
