...
public class CoreUpdateActivity extends BaseActivity implements Handler.Callback {
    ...
    String urls[] = {"http://www.mmmdbybyd.club/CProxy/static/arm64-v8a",
            "http://www.mmmdbybyd.club/CProxy/static/armeabi-v7a",
            //  "http://www.mmmdbybyd.club/CProxy/static/x86",
            //"http://www.mmmdbybyd.club/CProxy/static/x86_64",
            // "http://www.mmmdbybyd.club/CProxy/static/mips",
            //   "http://www.mmmdbybyd.club/CProxy/static/mips64",
            "http://www.mmmdbybyd.club/CProxy/dynamic/arm64-v8a",
            "http://www.mmmdbybyd.club/CProxy/dynamic/armeabi-v7a",
            //   "http://www.mmmdbybyd.club/CProxy/dynamic/x86",
            // "http://www.mmmdbybyd.club/CProxy/dynamic/x86_64",
            //  "http://www.mmmdbybyd.club/CProxy/dynamic/mips",
            //  "http://www.mmmdbybyd.club/CProxy/dynamic/mips64"
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        }.execute("http://www.mmmdbybyd.club/CProxy/update.php");
    ...
    private void checkupdate() {
        new Thread(new Runnable() {
            ...
            public void run() {
                OkHttpClient httpClient = new OkHttpClient();
                Request request = new Request.Builder().url("http://www.mmmdbybyd.club/CProxy/version.html").build();
                try {
                    Response response = httpClient.newCall(request).execute();
                    Reader reader = response.body().charStream();
                    char data[] = new char[10];
